...
public class BookStore {
    ...
    public int exercise04() {
        ...
        ArrayList<ArrayList<String>> result = bookPresentationManager.updateBookPresentationPriceForBooksWithMultipleFormats(3, 1.15);
    ...
    public void exercise08() {
        ...
        try {
            Charset charset = Charset.forName("UTF-8");
            BufferedWriter bufferedWriter = Files.newBufferedWriter(Paths.get(Constants.OUTPUT_DIRECTORY + "/08referrences.txt"), charset, StandardOpenOption.CREATE, StandardOpenOption.APPEND);
