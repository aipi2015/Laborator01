		...
		try (BufferedReader inputFileBufferedReader = Files.newBufferedReader(inputFile, charset)) {
			...
			do {
				...
				if (inputFileCurrentLine != null) {
					...
					ArrayList<ArrayList<String>> content = databaseOperations.getTableContent("writer", attributes,
							"id=" + writerId, null, null, null);
					assertEquals("writer " + writerId + " should have been deleted", 0,
